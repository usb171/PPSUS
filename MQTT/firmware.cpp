...
/**
 * Trabalho de Conclusão de Curso em Ciência da Computação - UESPI 2018
 * Instituição: Universidade Estadual do Piauí
 * Autor: Nilton Nonato Garcia Júnior
 *
 * Este programa faz a amostragem de sinais em uma taxa de 60 Hz persistindo em
 * uma mídia micro SD.
 *
 * Os dados são escritos em um arquivo binário em mútiplos blocos do cartão SD.
 *
 * São utilizados barramentos I2C para o módulo sensor GY-80 e SPI para o SD
**/
...
const uint32_t LOG_INTERVAL_USEC = 60000; // Em microseconds
...
void setup(void) {
  ...
  if (sizeof(block_t) != 512) error("Tamanho Bloco Inválido");
